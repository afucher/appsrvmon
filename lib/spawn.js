...
let run = (command, client, disableWatchINI) => {
  let shFlag = '/c';
  ...
  if(!disableWatchINI || !( disableWatchINI.toLowerCase() == 'yes' || disableWatchINI.toLowerCase() == 'sim' || disableWatchINI.toLowerCase() == 's' || disableWatchINI.toLowerCase() == 'y' || disableWatchINI.toLowerCase() == 'true' ) ) {
